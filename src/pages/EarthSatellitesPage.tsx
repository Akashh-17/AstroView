        ...
        <div className="relative h-full w-full flex flex-col bg-black text-white overflow-hidden">
            ...
            <div className="flex flex-1 overflow-hidden">
                ...
                <div className="flex-1 relative">
                    ...
                    <div className="absolute bottom-0 left-0 right-0 z-10 flex items-center justify-center gap-3 px-6 py-3 bg-gradient-to-t from-black/80 via-black/40 to-transparent">
                        <button
                            onClick={togglePause}
